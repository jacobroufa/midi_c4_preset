...
void displayPageChange(String value) {
  lcd.clear();
  lcd.setCursor(6, 0);
  lcd.print(value);
  delay(300);
...
void displayPresetScroll() {
  ...
  lcd.setCursor(9, 1);
  lcd.print((_presetPage * 4) + 5); // 0*4 + 5 = 5, 1*4 + 5 = 9, etc
  lcd.setCursor(17, 1);
  lcd.print((_presetPage * 4) + 6); // 0*4 + 6 = 6, 1*4 + 6 = 10, etc
}
